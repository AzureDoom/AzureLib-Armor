...
package mod.azure.azurelibarmor.core.state;

import mod.azure.azurelibarmor.core.animatable.model.CoreGeoBone;

/**
 * A state monitoring class for a given {@link CoreGeoBone}.<br>
 * Transformations applied to the bone is monitored by the {@link mod.azure.azurelibarmor.core.animation.AnimationProcessor}
