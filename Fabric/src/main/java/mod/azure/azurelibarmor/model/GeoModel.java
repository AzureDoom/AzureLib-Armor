...
public abstract class GeoModel<T extends GeoAnimatable> implements CoreGeoModel<T> {
	 ...
	 * @return An {@link Optional} containing the {@link mod.azure.azurelibarmor.cache.object.GeoBone} if one matches, otherwise an empty Optional
	 */
	public Optional<mod.azure.azurelibarmor.cache.object.GeoBone> getBone(String name) {
