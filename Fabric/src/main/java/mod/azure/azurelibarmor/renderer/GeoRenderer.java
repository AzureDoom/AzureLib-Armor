...
public interface GeoRenderer<T extends GeoAnimatable> {
	 ...
	 * <li>For {@link mod.azure.azurelib.animatable.GeoBlockEntity Tile Entities} and {@link mod.azure.azurelibarmor.animatable.GeoItem Items}, it's currently unused</li>
	 * </ul>
