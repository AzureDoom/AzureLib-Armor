...
/**
 * Metadata class that stores the data for AzureLib's {@link mod.azure.azurelibarmor.renderer.layer.AutoGlowingGeoLayer emissive texture feature} for a given texture
 */
