package mod.azure.azurelibarmor.rewrite.animation.controller.state.machine;
...
import mod.azure.azurelibarmor.rewrite.animation.controller.state.AzAnimationState;
import mod.azure.azurelibarmor.rewrite.animation.controller.state.impl.AzAnimationPauseState;
import mod.azure.azurelibarmor.rewrite.animation.controller.state.impl.AzAnimationPlayState;
import mod.azure.azurelibarmor.rewrite.animation.controller.state.impl.AzAnimationStopState;
import mod.azure.azurelibarmor.rewrite.animation.controller.state.impl.AzAnimationTransitionState;
import mod.azure.azurelibarmor.rewrite.util.state.StateMachine;
import mod.azure.azurelibarmor.rewrite.util.state.StateMachineContext;
