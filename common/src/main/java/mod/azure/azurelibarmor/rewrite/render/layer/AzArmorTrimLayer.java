 ...
 */
public class AzArmorTrimLayer implements AzRenderLayer<ItemStack> {
    ...
    @Override
    public void renderForBone(AzRendererPipelineContext<ItemStack> azRendererPipelineContext, AzBone azBone) {}
}
