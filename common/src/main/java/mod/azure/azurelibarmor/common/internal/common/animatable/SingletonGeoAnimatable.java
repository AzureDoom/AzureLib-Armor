 ...
 */
package mod.azure.azurelibarmor.common.internal.common.animatable;
...
public interface SingletonGeoAnimatable extends GeoAnimatable {
    ...
    /**
     * Register this as a synched {@code GeoAnimatable} instance with azurelibarmor's networking functions.<br>
     ...
     * <b><u>DO NOT OVERRIDE</u></b>
     *
     * @param relatedEntity  An entity related to the animatable to trigger the animation for (E.G. The player holding
     *                       the item)
     * @param instanceId     The unique id that identifies the specific animatable instance
    ...
    /**
     * Remotely triggers a client-side animation for this GeoAnimatable for all players targeted by the
     * packetTarget.<br>
     * This method should only be called on the <u>server side</u>.<br>
     * <b><u>DO NOT OVERRIDE</u></b>
     *
