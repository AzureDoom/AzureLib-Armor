 ...
 */
package mod.azure.azurelibarmor.common.api.client.model;

import mod.azure.azurelibarmor.core.animatable.GeoAnimatable;
import net.minecraft.resources.ResourceLocation;

/**
 * Defaulted model class for azurelibarmor models.<br>
...
public abstract class DefaultedGeoModel<T extends GeoAnimatable> extends GeoModel<T> {
    ...
    /**
     * Constructs a defaulted resource path for a geo.json file based on the input namespace and subpath, automatically
     * using the {@link DefaultedGeoModel#subtype() subtype}
     *
     * @param basePath The base path of your resource. E.G.
     *
     *                 <pre>{@code new ResourceLocation(MyMod.MOD_ID, "animal/goat")}</pre>
    ...
    /**
     * Constructs a defaulted resource path for a animation.json file based on the input namespace and subpath,
     * automatically using the {@link DefaultedGeoModel#subtype() subtype}
     *
     * @param basePath The base path of your resource. E.G.
     *
     *                 <pre>{@code new ResourceLocation(MyMod.MOD_ID, "animal/goat")}</pre>
