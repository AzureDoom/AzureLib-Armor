...
import mod.azure.azurelibarmor.common.internal.common.cache.object.*;
...
public interface GeoRenderer<T extends GeoAnimatable> {
     ...
     * All azurelibarmor renderers should immediately defer their respective default {@code render} calls to this, for
     * consistent handling
     */
     ...
     * a {@link GeoRenderLayer} or similar
     */
    ...
    /**
     * Calls back to the various {@link GeoRenderLayer RenderLayers} that have been registered to this renderer for
     * their {@link GeoRenderLayer#preRender pre-render} actions.
     */
    ...
    /**
     * Calls back to the various {@link GeoRenderLayer RenderLayers} that have been registered to this renderer for
     * their {@link GeoRenderLayer#renderForBone per-bone} render actions.
     */
     ...
     * Note that this does not render the bone itself. That should be done through {@link GeoRenderer#renderCubesOfBone}
     * separately
     */
     ...
     * part of a {@link GeoRenderLayer} or external render call.<br>
