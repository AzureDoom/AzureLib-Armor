 ...
 */
package mod.azure.azurelibarmor.common.api.client.renderer.dynamic;
...
import mod.azure.azurelibarmor.common.api.client.renderer.GeoArmorRendererConstants;
...
public abstract class DynamicGeoArmorRenderer<T extends Item & GeoItem> extends GeoArmorRenderer<T> {
    ...
    protected DynamicGeoArmorRenderer(GeoModel<T> model) {
        super(model);
    }
