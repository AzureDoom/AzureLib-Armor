...
public abstract class GeoModel<T extends GeoAnimatable> implements CoreGeoModel<T> {
    ...
    private final long lastRenderedInstance = -1;
    ...
    /**
     * Override this and return true if azurelibarmor should crash when attempting to animate the model, but fails to find a
     * bone.<br>
     * By default, azurelibarmor will just gracefully ignore a missing bone, which might cause oddities with incorrect models
        ...
        if (animatable instanceof Entity entity) {
            ...
            if (entity instanceof LivingEntity livingEntity) {
                ...
                parser.setMemoizedValue(
                        ...
                        () -> livingEntity.getViewYRot(
                                (float) animTime - livingEntity.getViewYRot((float) animTime - 0.1f))
                );
            }
        }
    }
