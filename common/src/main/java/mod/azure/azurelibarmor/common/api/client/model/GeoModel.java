...
public abstract class GeoModel<T extends GeoAnimatable> implements CoreGeoModel<T> {
    ...
    /**
     * Override this and return true if azurelibarmor should crash when attempting to animate the model, but fails to
     * find a bone.<br>
     * By default, azurelibarmor will just gracefully ignore a missing bone, which might cause oddities with incorrect
     * models or mismatching variables.<br>
     */
