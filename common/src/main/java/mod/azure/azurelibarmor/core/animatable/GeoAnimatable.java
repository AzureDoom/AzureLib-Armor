 ...
 * sub-interfaces relevant to your specific object so that your model can be automatically handled.<br>
 * See:<br>
 * <ul>
 * <li>{@code GeoBlock}</li>
...
public interface GeoAnimatable {
     ...
     * Override this method in your animatable object and add your controllers via
     * {@link AnimatableManager.ControllerRegistrar#add ControllerRegistrar.add}. You may add as many controllers as
     * wanted. <br>
     * <br>
     * Each controller can only play <u>one</u> animation at a time, and so animations that you intend to play
     * concurrently should be handled in independent controllers. Note having multiple animations playing via multiple
     * controllers can override parts of one animation with another if both animations use the same bones or child
     * bones.
     *
    ...
    /**
     * Defines the speed in which the {@link AnimationProcessor} should return {@link CoreGeoBone GeoBones} that
    ...
    /**
     * Defines whether the animations for this animatable should continue playing in the background when the game is
     * paused.<br>
     ...
     *
     * @param object An object related to this animatable relevant to tick calculation. Different subclasses will use
     *               this differently
