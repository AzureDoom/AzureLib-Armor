...
public final class AzureLibUtil {
	...
	/**
	 * Register a custom {@link mod.azure.azurelibarmor.core.animation.Animation.LoopType} with AzureLib, allowing for dynamic handling of post-animation looping.<br>
	...
	/**
	 * Register a custom {@link mod.azure.azurelibarmor.core.animation.EasingType} with AzureLib, allowing for dynamic handling of animation transitions and curves.<br>
	 * <b><u>MUST be called during mod construct</u></b><br>
	 * 
	...
	/**
	 * Register a custom {@link mod.azure.azurelibarmor.loading.object.BakedModelFactory} with AzureLib, allowing for dynamic handling of geo model loading.<br>
	 * <b><u>MUST be called during mod construct</u></b><br>
	 * 
	 ...
	 * NOTE: You do not need to register non-serializable {@link mod.azure.azurelibarmor.core.object.DataTicket DataTickets}.
	 * 
