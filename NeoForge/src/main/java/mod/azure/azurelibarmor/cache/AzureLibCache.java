...
import mod.azure.azurelibarmor.loading.json.FormatVersion;
...
/**
 * Cache class for holding loaded {@link mod.azure.azurelibarmor.core.animation.Animation Animations}
...
public final class AzureLibCache {
	...
	public static Map<ResourceLocation, BakedAnimations> getBakedAnimations() {
		if (!AzureArmorLib.hasInitialized)
	...
	public static void registerReloadListener() {
		...
		if (mc == null) {
			if (!ModLoader.isDataGenRunning())
				AzureArmorLib.LOGGER.warn("Minecraft.getInstance() was null, could not register reload listeners");
