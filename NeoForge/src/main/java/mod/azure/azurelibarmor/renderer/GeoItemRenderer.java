...
public class GeoItemRenderer<T extends Item & GeoAnimatable> extends BlockEntityWithoutLevelRenderer implements GeoRenderer<T> {
	...
	/**
	 * Wrapper method to handle rendering the item in a GUI context (defined by {@link net.minecraft.client.renderer.block.model.ItemDisplayContext#GUI} normally).<br>
