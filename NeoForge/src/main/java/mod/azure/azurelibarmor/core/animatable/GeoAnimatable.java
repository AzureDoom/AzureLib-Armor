...
/**
 * This is the root interface for all animatable objects in AzureLib.
...
public interface GeoAnimatable {
	 ...
	 * Override this method in your animatable object and add your controllers via {@link mod.azure.azurelibarmor.core.animation.AnimatableManager.ControllerRegistrar#add ControllerRegistrar.add}.
	 ...
	 * Generally speaking, you should create your cache using {@code AzureLibUtil#createCache} and store it in your animatable instance, returning that cached instance when called.
	 * @return A cached instance of an {@code AnimatableInstanceCache}
	 */
	AnimatableInstanceCache getAnimatableInstanceCache();

	/**
	 * Defines the speed in which the {@link mod.azure.azurelibarmor.core.animation.AnimationProcessor} should return
