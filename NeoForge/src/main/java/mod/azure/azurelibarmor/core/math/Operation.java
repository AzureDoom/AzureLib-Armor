 ...
 *
 * This enumeration provides different hardcoded enumerations of default math
 * operators such addition, substraction, multiplication, division, modulo and
 * power.
 *
...
public enum Operation {
	...
	/**
	 * Value of this operation in relation to other operations (i.e precedence
	 * importance)
	 */
