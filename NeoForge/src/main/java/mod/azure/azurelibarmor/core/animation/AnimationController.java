...
import mod.azure.azurelibarmor.core.keyframe.BoneAnimationQueue;
...
public class AnimationController<T extends GeoAnimatable> {
	...
	/**
	 * Cache the relevant {@link BoneSnapshot BoneSnapshots} for the current {@link mod.azure.azurelibarmor.core.animation.AnimationProcessor.QueuedAnimation}
